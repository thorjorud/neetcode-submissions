...
'''
    Brute Force Approach: Check each row, column and 3x3 box independently in 3 seperate passes.
    While still O(N^2) time theoretically, brute force requires 3x as many cell lookups in practice, making this 
    single-pass tracking significantly more efficient.
'''