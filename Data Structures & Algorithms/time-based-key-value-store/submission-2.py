class TimeMap:
    ...
    def get(self, key: str, timestamp: int) -> str:
        ...
        - We could scan backward through the values array from the end to the 
          beginning to find the first entry where current_timestamp <= timestamp.
        - Brute Force Time Complexity: O(n) linear scan in the worst-case scenario.
        - Optimization: Because the problem guarantees timestamps are strictly 
          increasing, the array is pre-sorted, allowing for this O(log n) Binary Search.
        '''
        res = ""
