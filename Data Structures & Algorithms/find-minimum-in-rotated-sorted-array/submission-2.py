class Solution:
    ...
    '''
    Key Takeaway: If an array is completely unsorted, you must check every element (O(n)). 
    The moment you know an array is sorted (even if it's rotated), 
    you can leverage Binary Search to skip entire sections of data, 
    drastically dropping the time complexity to O(log n).
    '''